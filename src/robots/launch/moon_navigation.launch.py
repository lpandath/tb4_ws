...
def generate_launch_description():
    ...
    Run localization separately first (moon_localization.launch.py),
    set /Moon/initialpose, then run this.
    ...
    default_params_yaml = os.path.join(robots_share, "config", "moon_navigation.yaml")
