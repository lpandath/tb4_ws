...
def generate_launch_description():
    """
    Robust bringup for Basin robot:
    ...
    scan_launch = os.path.join(robots_share, "launch", "basin_scan.launch.py")
    localization_launch = os.path.join(robots_share, "launch", "basin_localization.launch.py")
    navigation_launch = os.path.join(robots_share, "launch", "basin_navigation.launch.py")
