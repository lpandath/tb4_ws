...
def generate_launch_description() -> LaunchDescription:
    ...
    common_params = [
        ...
        {"radius": 0.8},
        {"linear_speed": 0.0},
        # Slower/quieter rotation for home testing.
        {"angular_speed": LaunchConfiguration("angular_speed")},
        # feet -> meters: 1ft=0.3048m
        # Tuned for a tight space where furniture is ~0.85m away:
        # - Only start when a person is closer than ~0.75m.
        # - Pause if someone gets closer than ~0.45m.
        # - Resume once clear past ~0.65m.
        {"stop_distance": 0.45},
        {"resume_distance": 0.65},
        {"start_distance": 0.75},
        # Narrow forward cone to reduce side furniture influence.
        {"scan_angle_min_deg": -25.0},
        {"scan_angle_max_deg": 25.0},
        # Ignore very tiny near-field spikes.
        {"scan_min_range": 0.2},
        # Robust distance and gating: average of K smallest + require multiple beams.
        {"min_k_for_distance": 8},
        {"stop_beams_required": 2},
        {"start_beams_required": 2},
        # Debounce to avoid rapid toggling from scan noise.
        {"debounce_start_s": 0.25},
