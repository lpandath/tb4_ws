...
echo "[3/3] Starting basin_monitor (production)..."
echo ""
...
uv run --python python3.12 --with-requirements monitor/requirements.txt monitor/basin_monitor.py
